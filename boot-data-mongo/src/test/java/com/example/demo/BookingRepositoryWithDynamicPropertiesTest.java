...
@ActiveProfiles("test")
public class BookingRepositoryWithDynamicPropertiesTest {
    ...
    public void setup() {
        ...
        this.posts.saveAll(
                        List.of(
                                Booking.builder().content("my test content").content("my test title").build(),
                                Booking.builder().content("content of another post").content("another post title").build()
                        )
                )
    ...
    public void testGetAllPost() {
        this.posts.findAll(Sort.by("title"))
                ...
                .consumeNextWith(p -> {
                    ...
                    assertThat(p.getCreatedBy()).isEqualTo("Venu");
